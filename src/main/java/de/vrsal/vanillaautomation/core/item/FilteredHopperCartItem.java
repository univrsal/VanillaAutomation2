...
public class FilteredHopperCartItem extends Item {
    ...
    private static final IDispenseItemBehavior MINECART_DISPENSER_BEHAVIOR = new DefaultDispenseItemBehavior() {
        ...
        public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            AbstractMinecartEntity abstractminecartentity = new FilteredHopperCartEntity(world, d0, d1 + d3, d2);
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!blockstate.isIn(BlockTags.RAILS)) {
            ...
            if (!world.isRemote) {
                ...
                FilteredHopperCartEntity minecartentity = new FilteredHopperCartEntity(world, (double) blockpos.getX() + 0.5D, (double) blockpos.getY() + 0.0625D + d0, (double) blockpos.getZ() + 0.5D);
